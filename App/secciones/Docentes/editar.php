...
if(isset($_GET['txtID'])){
    ...
    $sentencia = $conexion->prepare("SELECT * FROM Docentes where id=:id");
...
if($_POST){
    ...
    $sentencia = $conexion->prepare("UPDATE Docentes 
    SET primerNombre = :primerNombre, segundoNombre = :segundoNombre, 
    primerApellido = :primerApellido, segundoApellido = :segundoApellido, 
    foto = :foto, cv = :cv, idmaterias = :idmaterias, fechaIngreso = :fechaIngreso 
    WHERE id = :id");
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="cv" class="form-label">Programa De Asignatura </label>
            ...
            <div class="mb-3">
                <label for="idmaterias" class="form-label"> Materias</label>
                <input type="text" value="<?php echo $idmaterias; ?>"
                class="form-control" name="idmaterias" id="idmaterias" aria-describedby="helpId" placeholder="Seleccionar la materia ">
            </div>
