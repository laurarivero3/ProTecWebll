...
(select NombreDelPuesto from puestos where puestos.id=empleados.idpuesto 
limit 1 )as puestos FROM empleados"); 
$sentencia->execute(); 
...
<div class="card">
    <div class="card-header">
        ...
        <!--bs5-button-a-->
        <a name=""id=""class="btn btn-primary"href="crear.php"role="button">Nuevo Empleado</a>
